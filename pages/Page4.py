...
desc_msg = '''
    **คำอธิบาย:**\n
    การวิเคราะห์ชื่อสินค้าที่ขายดีบน Shopee และ Lazada พบว่าคำที่เกี่ยวข้องกับสุขภาพและคุณสมบัติพิเศษ เช่น "เส้นไข่ขาว", "ไร้แป้ง", "Keto", และ "โปรตีน" มักปรากฏบ่อยในชื่อสินค้าที่มียอดขายสูง คำเหล่านี้แสดงถึงความเป็นเอกลักษณ์ของสินค้าที่มีคุณสมบัติพิเศษ เช่น สินค้าเพื่อสุขภาพหรือการรับประทานอาหารที่ปลอดภัย ดังนั้น การใช้คำเหล่านี้ในการตั้งชื่อผลิตภัณฑ์จะช่วยให้ชื่อสินค้าดูโดดเด่น ดึงดูดความสนใจจากกลุ่มลูกค้าที่มองหาสินค้าที่มีคุณสมบัติเฉพาะเจาะจง
'''
summary_msg = '''
    **สรุป:** คำที่เกี่ยวข้องกับสุขภาพ เช่น "เส้นไข่ขาว", "ไร้แป้ง", "Keto", และ "โปรตีน" ควรใช้ในการตั้งชื่อผลิตภัณฑ์เพื่อดึงดูดความสนใจของลูกค้าที่ให้ความสำคัญกับสุขภาพและคุณภาพสินค้า
'''
